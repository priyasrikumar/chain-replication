...
if __name__ == '__main__':
    ...
    stride = int((rbound - lbound) / numClients)
...
#    CLI(net)
    ...
    print(net.get('tester').cmd('_build/default/tester/tester_bin/tester.exe -mininet {0} {1} {2} -duration {3}'.format(serverString, clientString, backupString, duration)))
#    CLI(net)
